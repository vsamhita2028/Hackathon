    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(final MapboxMap mapboxMap) {
        ...
        customThemeManager = new CustomThemeManager(chosenTheme, MapActivity.this);
          ...
          mapboxMap.setStyle(new Style.Builder().fromUri("mapbox://styles/powerpuffgirlss/ckad3hzb403fr1it9foe5pg0c"),
    ...
    for (int i = 0; i < featureList.size(); i++) {
      if (featureList.get(i).getStringProperty("name").equals(selectedLocation.getName())) {
        if (featureSelectStatus(i)) {
            ...
            editor.putString("Store",featureList.get(i).getStringProperty("name").toString());
